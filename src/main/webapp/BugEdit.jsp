...
<body>
    ...
    <form action="manageBug">
      ...
      <tr><td valign="top">Description </td><td> <textarea rows="14" cols="125" name="<%=PropertyNames.BUG_DESCRIPTION%>" placeholder="Edit bug description here"><%=bug.getDescription()%></textarea> </td></tr>
