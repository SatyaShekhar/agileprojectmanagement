    ...
    <table border="0" bgcolor="white" cellpadding="1" cellspacing="1" id="table-1" name="table-1" align="center"
        ...
        <tr>
            <td colspan="11" align="right">
                ...
                onclick="window.open('UserStoryCreateNew.jsp?<%=PropertyNames.ITERATION_ID + "=" + iterationId%>', 'newwindow', 'location=100,menubar=0,toolbar=0,scrollbars=0,width=600,height=300,left=100,top=100')">
            </td>
        </tr>
        <%
        ...
        <tr id="<%=userStory.getUserstoryId()%>" style="display: none;">
            ...
            <td align="right">
                <img width="17" title="Edit task" src="images\icons\edit-pic.png"
                    onclick="window.open('BugEdit.jsp?<%=PropertyNames.BUG_ID + "=" + bug.getBugId()%>', 'newwindow', 'location=100,menubar=0,toolbar=0,scrollbars=0,width=1000,height=1000')">
                <img width="17" title="Copy or duplicate bug (not supported yet)" src="images\icons\copy-image.jpg">
