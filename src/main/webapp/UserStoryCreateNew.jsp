...
<body>
    ...
    <form action="manageUserStory">
        ...
        <table>
            ...
            <tr>
                <td colspan="2"><input type="text" size="70" name="<%=PropertyNames.USERSTORY_NAME%>" placeholder="User story name required">
                </td>
            </tr>
            <tr>
                <td valign="top" colspan="2"><textarea rows="8" cols="70" name="<%=PropertyNames.USERSTORY_DESCRIPTION%>" placeholder="User story description"></textarea></td>
            </tr>
            <tr>
                <td>Engineer</td>
