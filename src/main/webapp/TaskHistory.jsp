...
<body>
    ...
    <%
            ...
            logger.info("Selected Task ID: " + taskId);
            if (taskId == null) {
            ...
            if (task == null) {
                throw new IllegalStateException("Task can not be null here for ID : " + task);
            }
            Set<PastInformation> logs = task.getHistory().getInformations();
