...
<table >
    ...
    <tr><td colspan="2"> <input type="text" size="70" name="<%=PropertyNames.PROJECT_NAME%>" placeholder="Project description"> </td></tr>
    <tr valign="top"><td colspan="2"> 
    <textarea rows="6" cols="70" name="<%=PropertyNames.PROJECT_DESCRIPTION%>" placeholder="Project description"></textarea>
    </td></tr>
    <tr><td colspan="2">Engineer
